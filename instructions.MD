...
- **Aikido Safe Chain** is upstream software by **AikidoSec** ([AikidoSec/safe-chain](https://github.com/AikidoSec/safe-chain)); this repo only ships Kandji automation around it.
